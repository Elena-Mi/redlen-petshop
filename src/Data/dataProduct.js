...
const dataProduct = [
    ...
    },
    {
        ...
        description: " Удобная перчатка-салфетка для мытья питомца. В упаковке 50 штук",
        weight: '200 г',
        price: 281,
        category: 'ДОМАШНИИЙ УХОД',
        title: 'wash-napkin',
    ...
    },
    {
        id: 27,
        img: "big-feather-one",
        imgTwo: 'big-feather-two',
        imgThree: 'big-feather-three',
    ...
    {
        id: 31,
        img: "smal-big-tray-one",
        imgTwo:'smal-big-tray-one',
        imgThree: 'smal-big-tray-three',
